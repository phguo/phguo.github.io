...
% Nanjing University of Aeronautics and Astronautics & (+86)***-****-****\\
% 29 Jiangjun Avenue, Nanjing  & guopenghui@nuaa.edu.cn \\
% Jiangsu, China 211106 & https://guo.ph
% \end{tabular}
...
% \textbf{\textit{LRP2E-instances }} https://github.com/phguo/LRP2E-instances \hfill Jan. 2018
% \begin{itemize}
% \item Instances data for 2-echelon vehicle routing problem (VRP2E) with resource constraints. 
% \end{itemize}

% \section{\sc Computer \\ Skills}
%    \begin{tabular}{l p{3in}}
%     \underline{Languages:} & Python \\
%      \underline{Software:} &  Gurobi 
%  \end{tabular}
